...
describe('validateCityName', () => {
  it('Пропускает корректное название города', () => {
  ...
  it('Не пропускает пустое значение', () => {
    const city_empty = ''
  ...
  it('пропускает названия с восклицательным знаком или дефисами', () => {
